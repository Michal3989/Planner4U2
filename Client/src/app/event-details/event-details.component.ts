...
export class EventDetailsComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    let currentEvent: EventDto = await this.eventService
      .getDefaultEvent(this.commonService.currentOwner.id)
      .toPromise();
  ...
  saveNewEvent() {
    ...
    this.eventService
      .saveNewEvent(this.commonService.currentEvent, frmData)
  ...
  updateEvent() {
    ...
    debugger;
    this.eventService
      .updateEvent(this.commonService.currentEvent, frmData)
  ...
  setFormGroupsValues() {
    this.eventDetailsForm = new FormGroup({
      eventTypeCode: new FormControl(
        this.commonService.currentEvent.eventTypeCode,
        [Validators.required]
      ),
      date: new FormControl(
        this.datePipe.transform(
          this.commonService.currentEvent.date,
          "yyyy-MM-dd"
        ),
        [Validators.required]
      ),
      name: new FormControl(this.commonService.currentEvent.name, [
        Validators.required
      ]),
